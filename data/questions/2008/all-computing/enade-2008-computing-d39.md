...
B Existem diferentes derivações para a expressão (((a + b) * c) + (d * e)). É correto, então, afirmar que a gramática acima é ambígua? Justifique sua resposta. (valor: 5,0 pontos)
